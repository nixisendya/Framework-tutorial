Pod::Spec.new do |spec|
  ...
  spec.homepage     = "https://github.com/nixisendya/Framework-tutorial"
  ...
  spec.author             = { "nixisendya" => "rayennixi@gmail.com" }
  ...
  spec.source       = { :git => "https://github.com/nixisendya/Framework-tutorial.git", :tag => "#{spec.version}" }
